...
import com.cx.http.handler.HttpHandler;
...
public class Server implements Runnable {
    ...
    public void run() {
        try {
            ...
            String xmlPath = URLDecoder.decode(this.getClass().getClassLoader().getResource("server.xml").getPath(), "utf-8");
            String portStr = XMLUtil.getRootElement(xmlPath).element("port").getText();
